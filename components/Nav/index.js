...
function Nav() {
  ...
  return (
    <nav className="relative">
      <div className="absolute z-10 top-0 left-0 bg-gradient-to-r from-[#06202A] h-10 w-1/12 sm:w-0" />
      ...
      <div className="absolute top-0 right-0 bg-gradient-to-l from-[#06202A] h-10 w-1/12 sm:w-0" />
    </nav>
  );
}
